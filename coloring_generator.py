...
AGE_GROUP_PROMPTS = {
    "3-5years": [
        "A tiny cloud bakery where cupcakes grow on cloud bushes and a smiling sun buys one.",
        "A panda riding a soap bubble like a boat across a bathtub ocean with rubber-duck islands.",
        "A friendly dinosaur wearing pajamas, brushing its teeth with a toothbrush as big as a broom.",
        "A kitten magician pulling colorful scarves out of a top hat that is bigger than the kitten.",
        "A snail racing a turtle on a leaf racetrack, with cheering ladybugs on the sidelines.",
        "A cozy mushroom house with a door shaped like a cookie and a welcome mat made of petals.",
        "A baby dragon learning to blow bubbles instead of fire, making bubble hearts in the air.",
        "A giraffe using its long neck as a slide for tiny birds to play on.",
        "A teddy bear piloting a cardboard spaceship through a bedroom galaxy of pillows and blankets.",
        "A cheerful octopus wearing a crown, having a beach picnic with sandwiches shaped like stars.",
        "A little elephant painting rainbow footprints while dancing through soft mud.",
        "A penguin wearing a scarf, carrying a big balloon that lifts it slightly off the ground.",
        "A smiling watermelon car with tiny wheels driving down a candy road.",
        "A unicorn making a flower smoothie in a blender that sparkles like a treasure chest.",
        "A friendly robot planting lollipops in a garden and watering them with a teapot.",
        "A whale floating above a playground, gently holding a swing with its tail.",
        "A bunny chef stacking pancakes into a tall tower that almost touches the ceiling.",
        "A lion with a fluffy mane made of cotton candy, licking a melting ice cream cone.",
        "A duck family wearing rain hats, marching in a puddle parade with splashy music notes.",
        "A sleepy moon tucking in the stars like little blankets around a small town.",
    ],
    "5+years": [
        "A library inside a giant turtle shell, where books glide on little floating shelves like boats.",
        "A secret train station in the clouds, with airship tickets printed on rainbow strips.",
        "A detective raccoon solving a mystery of missing cookies in a moonlit kitchen, leaving playful clues.",
        "A city built on the backs of gentle whales, connected by rope bridges and floating lanterns.",
        "A wizard's workshop where clocks talk, teacups sing, and gears turn into butterflies.",
        "A submarine school bus picking up sea-creature students at coral 'bus stops' with shell signs.",
        "A festival where dragons fly kites shaped like constellations across a sunset sky.",
        "A floating island farm where clouds are sheep and the windmills grind stardust into flour.",
        "A candy jungle expedition with explorers crossing a syrup river on wafer rafts and gumdrop rocks.",
        "A space aquarium with glass tunnels, giant jellyfish overhead, and alien kids pressing their hands to the glass.",
        "A mountain ski resort run by penguins, with cocoa huts and a snowball 'ticket booth.'",
        "A night market on the moon selling meteor-marshmallows and comet lemonade from tiny stalls.",
        "A robot gardener growing geometric flowers that unfold like origami in a glass greenhouse.",
        "A castle kitchen where pots dance, spoons juggle, and soup swirls into tiny star patterns.",
        "A medieval parade where knights ride giant snails, waving banners made from stitched leaves.",
        "A sky harbor where suitcases roll by themselves and clouds are shaped like animals guiding travelers.",
        "An underwater coral city with fish-shaped traffic lights, submarine taxis, and a friendly diver waving.",
        "A lighthouse on a floating iceberg, shining a beam that turns into a rainbow bridge for seabirds.",
        "A deep-sea neighborhood where an octopus mail carrier delivers letters sealed with pearl stamps.",
        "A fantasy city street where shadows become playful pet animals, and kids chase them under glowing lanterns.",
    ],
}
